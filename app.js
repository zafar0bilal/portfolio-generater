...
function renderPreview(){
 const i=state.template,d=designs[i],skills=splitList(state.skills),anim=state.animation==="auto"?d[5]:state.animation;
 ...
 $("livePreview").innerHTML=`<div class="site t${(i%24)+1}" data-anim="${anim}">
